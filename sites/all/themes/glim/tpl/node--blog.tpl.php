		...
		<div class="col-md-10 col-md-offset-1">
			<div id="primary" class="content-area">
				<main id="main" class="site-main">
					<article class="post hentry <?php print $class_art; ?>">
                    ...
                    <?php } ?>
                        <header class="entry-header">
                            ...
                            <div class="entry-meta">
                                <span class="cat-links">
                                    <?php print strip_tags(render($content['field_categories']),'<a>');?>
                                </span>
                        ...
                        <div class="entry-content">
                        	<span class="screen-reader-text"></span>
                        	<?php print render($content['field_chat']); ?>
                        	<div class="mb-20"></div>
                        	...
                        	<div class="footer-meta clearfix">  
	                            <div class="post-comment">
	                                <a href="#" class="comments-link">
	                                    <span><?php print $comment_count.' Comments'; ?></span>
	                                </a>
	                            </div>
	                            <div class="share-area">
	                                <div> 
	                                    <a href="https://twitter.com/share?url=<?php print $base_root.$node_url; ?>&text=<?php print $title; ?>"><span class="fa fa-twitter"></span></a>
	                                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php print $base_root.$node_url; ?>"><span class="fa fa-facebook"></span></a>
	                                    <a href="https://plus.google.com/share?url=<?php print $base_root.$node_url; ?>"><span class="fa fa-google-plus"></span></a>
	                                    <a href="https://www.instagram.com/share?url=<?php print $base_root.$node_url; ?>"><span class="fa fa-instagram"></span></a>
	                                    <a href="https://dribbble.com/share?url=<?php print $base_root.$node_url; ?>"><span class="fa fa-dribbble"></span></a>
	                                </div>
	                            </div>
	                            <div class="post-view">
					...
					<div class="author-info clearfix">
						<div id="author-img">
							<figure class="at-img">
                                <?php print strip_tags(theme('user_picture', array('account' => $node_author)),'<img>'); ?>
                            </figure>
                            <h3 class="author-name"><?php print $name;?></h3>  
						</div>
						<div id="author-details">
                            ...
                            <footer id="author-meta" class="clearfix">
                                <div class="post-count">
                                    <b>
                                    	<a href="#">
                                    		<?php print strip_tags(drupal_get_count_post()); ?> Total Posts
										</a>
									</b>
                                </div>

                                <div class="authors-social">
                                    <b><?php print t('Follow Me');?></b>
                                    <?php print $node_author->field_social_network['und'][0]['value']?>
                                </div> 
                            </footer>
						</div>
					</div>
					<nav class="post-navigation clearfix">
						<div class="post-previous">
							<?php print glim_prev_next($nid,'blog','p'); ?>
						</div>
						<div class="post-next">
							<?php print glim_prev_next($nid,'blog','n'); ?>
						</div>
					</nav>
					<?php

						$subs = block_get_blocks_by_region('bot_content');
		...
		<div class="col-md-12">
			<div id="primary" class="content-area">
                <main id="main" class="site-main">
                	...
                	<div class="row">
                		<div class="col-sm-10 col-sm-offset-1" id="post-others">                           
                			<div class="author-info clearfix">
								<div id="author-img">
									<figure class="at-img">
		                                <?php print strip_tags(theme('user_picture', array('account' => $node_author)),'<img>'); ?>
...
<article class="post <?php print $class_art; ?> hentry">
    ...
    <div class="entry-content">
        ...
        <?php 
        if(!empty($node->field_chat)) {
        	print render($content['field_chat']);
        } else {
        ?>
        	<p><?php print strip_tags(render($content['body']),'<a>'); ?></p>
        <?php } ?>
    </div> <!-- .entry-content -->
    ...
    <footer class="entry-footer clearfix"> 
		...
		<div class="more-wraper">
            <a href="<?php print $node_url; ?>" class="more-link">Continue</a>    
        </div>                            
		<?php endif;?> 
